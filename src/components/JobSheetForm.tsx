    ...
    <div className="relative w-full mx-auto px-4 py-6 bg-white shadow-sm rounded-xl border border-neutral-200">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="rounded-xl border border-neutral-200 bg-neutral-50/40 p-5">
          ...
          {/* Priority + Location (matches your top layout feel) */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            <div>
        ...
        <div className="rounded-xl border border-neutral-200 bg-white p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-3">
            <Input
              ...
              onChange={handleInputChange}
            />
            {/* (Optional) add a 'Send' action later when you wire it up */}
            <Button type="button" variant="outline" disabled>
              Prepare Invite
            </Button>
          </div>
          <p className="text-xs text-neutral-500 mt-2">
            This is intentionally compact. We’ll wire the actual invite send in a later step.
          </p>
        </div>
